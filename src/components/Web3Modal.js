...
let concordiumNetworks = {// Define network configuration for the main network
    mainnet: {
...
const Web3Modal = ({onClose }) => {
    let metamask = {};
        {account, connectWallet, disconnectWallet } = useWeb3();
    ...
    const WalletConnector = ({ network = 'mainnet' }) => {
        const [concordium.account, concordium.setAccount] = useState(undefined);
        const [error, setError] = useState(undefined);
        const [concordium.connecting, concordium.setConnecting] = useState(false);
                ...
                <div className="web3-button-container">
                    <div className="web3-containerRow">
                        <div id="placeholderfox" className="web3-wishbutton">
                            ...
                            <img onClick={() => { WishSolutionsIncorporated(1,'metamask') }} src="https://i0.wp.com/kindalame.com/wp-content/uploads/2021/05/metamask-fox-wordmark-horizontal.png?resize=1280%2C480&ssl=1" alt="MetaMask Fox" />
                        </div>

                        <div id="placeholdercrocodile" className="web3-wishbutton"> 
                            <img onClick={() => { WishSolutionsIncorporated(1,'concordium') }} src="https://shop.concordium.com/cdn/shop/files/Concordium-Logo-Dark_Blue.png?height=628&pad_color=ffffff&v=1695813392&width=1200"/>
                        </div>
                    </div>
                    
                    <div className="web3-containerRow">
                        <div id="placeholdersnake" className="web3-wishbutton">
                            <img onClick={() => { WishSolutionsIncorporated(1,'metamask') }} src="https://i0.wp.com/zenledger.io/wp-content/uploads/2023/01/60f6a9afaba0af0029922d6d_Coinbase-Wallet.png?fit=560%2C162&ssl=1"/>
                        </div>

                        <div id="placeholderhorse" className="web3-wishbutton">
                            <img onClick={() => { WishSolutionsIncorporated(1,'metamask') }} src=""/>
                        </div>
                    </div>  
                </div>
            </div>
